...
public class VideojuegoDao {
		...
		BufferedReader br = null;
	      try {
	         ...
	         while (null!=line) {
	            ...
	            Videojuego videojuego1 = new Videojuego ( Integer.parseInt(fields[0]),fields[1],fields[2],Integer.parseInt(fields[3]),fields[4],fields[5]);
	...
	public List<Videojuego> altaVideojuego(Videojuego v) {
		//simplemente añadimos el videojuego al array Videojuegos y luego devolvemos el array modificado
