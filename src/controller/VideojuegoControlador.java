...
public class VideojuegoControlador {
	...
	public static void altaOption(Scanner sc, VideojuegoService videojuegoService) {
		...
		System.out.println("--------------------------------------------------------------");
		System.out.println("Introduzca el a�o de publicaci�n del Videojuego:");
		int year = sc.nextInt();
		System.out.println("--------------------------------------------------------------");
		System.out.println("Introduzca la plataforma para la que est� creado el Videojuego:");
		String plataforma = sc.next();
		System.out.println("--------------------------------------------------------------");
		System.out.println("Introduzca el g�nero del Videojuego:");
